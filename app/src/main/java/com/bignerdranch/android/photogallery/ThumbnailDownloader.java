...
/**
 * Created by eliballislife11 on 7/31/17.
 */

public class ThumbnailDownloader<T> extends HandlerThread {
    private static final String TAG = "ThumbnailDownloader";
    private static final int MESSAGE_DOWNLOAD = 0;      // The what field for a message
    ...
    /**
     * queueThumbnail obtains and sends messages.
     * @param target is the PhotoHolder
     * @param url the URL of the thumbnail photo
     */
    ...
    /**
     * Helper function for onLooperPrepared()
     * @param target
     */
